...
namespace TFE_Input
{
	...
	static InputBinding s_defaultControllerBinds[] =
	{
		...
		{ IAS_SYSTEM_MENU,	ITYPE_CONTROLLER, CONTROLLER_BUTTON_DPAD_RIGHT },
		
		{ IADF_MENU_TOGGLE,	ITYPE_CONTROLLER, CONTROLLER_BUTTON_START },
		{ IADF_PDA_TOGGLE,	ITYPE_CONTROLLER, CONTROLLER_BUTTON_BACK },

		{ IADF_USE,		ITYPE_CONTROLLER, CONTROLLER_BUTTON_A },
		{ IADF_PRIMARY_FIRE,	ITYPE_CONTROLLER, CONTROLLER_BUTTON_B },
		{ IADF_CYCLEWPN_NEXT,	ITYPE_CONTROLLER, CONTROLLER_BUTTON_X },
		{ IADF_JUMP,		ITYPE_CONTROLLER, CONTROLLER_BUTTON_Y },


		{ IADF_RUN,		ITYPE_CONTROLLER, CONTROLLER_BUTTON_LEFTSHOULDER },
		{ IADF_SECONDARY_FIRE,	ITYPE_CONTROLLER, CONTROLLER_BUTTON_RIGHTSHOULDER },
		
		{ IADF_AUTOMAP,		ITYPE_CONTROLLER, CONTROLLER_BUTTON_DPAD_UP },
		{ IADF_CROUCH,		ITYPE_CONTROLLER, CONTROLLER_BUTTON_DPAD_DOWN },
		{ IADF_CYCLEWPN_PREV,	ITYPE_CONTROLLER, CONTROLLER_BUTTON_DPAD_LEFT },
#else
