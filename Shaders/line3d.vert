...
attribute vec3 vtx_pos;		// vertex position.
attribute vec4 vtx_uv;			// line pos 0 (xyz); pos0, pos1 (xy,zw) 
attribute vec2 vtx_uv1;		// line pos 1 (xy)
attribute vec4 vtx_uv2;		// offsets (curve).
attribute vec4 vtx_color;		// vertex color.
